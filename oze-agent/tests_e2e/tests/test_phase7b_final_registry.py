...
def test_total_scenario_count_after_phase7b_final():
    """The original 7B-final target added 22 scenarios on top of 26 existing ones.

    Later slices may add more scenarios; this test should only protect against
    accidentally dropping required 7B-final coverage.
    """
    assert len(SCENARIOS) >= 48, (
        f"expected at least 48 scenarios after 7B-final; got {len(SCENARIOS)}: "
